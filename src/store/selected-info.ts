...
const EdgeInfo = types.model("EdgeInfo", {
  type: types.string,
...
export default types.optional(
  types
    ...
    .views((self) => ({
      get currentShape() {
        return (getRoot(self) as any).ui.shapeIndex;
      },
      get currentFace() {
        return (getRoot(self) as any).ui.highlightedFaceIndex;
      },
      get currentEdge() {
        return (getRoot(self) as any).ui.highlightedEdgeIndex;
      },
      get faceInitialized() {
        return (
    ...
    .extend((self) => {
      let faceDisposer: (() => void) | null = null;
      let edgeDisposer: (() => void) | null = null;
